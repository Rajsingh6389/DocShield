  ...
  return (
    <div className="relative pb-24">
      ...
      <div className="mb-8 border-b border-white/5 pb-6">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black font-hud text-white tracking-[0.1em] sm:tracking-widest neon-text-glow uppercase break-words">Secure_Upload</h2>
